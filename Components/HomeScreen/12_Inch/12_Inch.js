...
export default class TwelveInch extends Component {
  ...
  render() {
    ...
    return (
     <View style={styles.page}>
          <View>
              <ToolBar sceneName={'12"s'} navigator={this.props.navigator}/>
          </View>
...
AppRegistry.registerComponent('TwelveInch', () => TwelveInch);